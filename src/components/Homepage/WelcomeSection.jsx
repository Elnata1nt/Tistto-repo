...
const WelcomeSection = () => {
  return (
    <section className="relative flex items-center justify-center min-h-screen bg-black py-20 md:py-28 border-b-2 border-primary px-6 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-accent to-primary opacity-60 -z-10"></div>
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <button className="bg-primary text-white font-bold py-3 px-6 md:py-4 md:px-8 lg:py-5 lg:px-10 rounded-lg shadow-lg hover:bg-opacity-80 transition-all duration-300">
          Saiba Mais
        </button>
      </div>
    </section>
